  ...
  return (
    <div className=" my-10 mx-auto max-w-7xl px-4 py-8">
      <Link href={"/Jak_pracujemy"}>
        <div className=" p-2 border border-black w-32 text-black flex justify-center items-center rounded-md font-semibold mb-4">
          Powrót →
        </div>
      </Link>
      ...
      <p className="text-pink-700 text-xl font-semibold mb-12">
        Wiek: {project.age}
      </p>
      ...
      <div className="mb-8 mt-20">
        <h3 className=" text-4xl text-pink-700 font-semibold mb-10">
          Dlaczego warto?
        </h3>
