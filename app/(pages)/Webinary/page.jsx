    ...
    <div className="w-full">
      <div className="max-w-6xl pb-20 m-auto flex-col justify-center items-start pt-10">
        <div className="flex-col mb-10 pb-6 border-b">
          <h2 className="font-display text-2xl md:text-xl text-gray-700 text-center">
            Przegapiłeś spotkanie z cyklu o E-uzależnieniach?
          </h2>

          <div className="flex gap-8 mt-3 justify-center items-center">
            <Link
              href={
                "https://sklep.rybnikonline.eu/?product_cat=szkolenia-online-offline"
              }
              target="_blank"
            >
            ...
            <Link
              href={"https://www.youtube.com/channel/UCsEXOxpnjOWB5XMJo46-whg"}
              target="_blank"
            >
              <div className="h-16 w-60 md:w-[300px] rounded-md border border-gray-300 flex items-center justify-center">
        ...
        <div className="flex-col border-b pb-10">
          <h2 className="font-display text-6xl md:text-6xl text-center">
            Nadchodzący cykl webinariów
          </h2>
          <p className="font-display text-3xl md:text-3xl mt-4 text-gray-700 text-center">
            Stany lękowe/nadwrażliwość
          </p>
          ...
          <div className="mt-6 flex justify-center gap-20">
            <div className="flex items-center justify-center text-center gap-6">
              <HoverCard>
                <HoverCardTrigger className=" text-black p-4 border rounded-md">
                  Wioletta Ginter
                </HoverCardTrigger>
                <HoverCardContent>
                  Magister pedagogiki specjalizujący się w poradnictwie
                  i&nbsp;pomocy psychopedagogicznej. Jako aktywny pedagog
                  specjalny, terapeuta ręki, specjalista w edukacji włączającej
              ...
              <HoverCard>
                ...
                <HoverCardContent>
                  Magister psychologii, specjalizujący się w seksuologii
                  klinicznej i psychologii kryminologicznej. Wykładowca studiów
                  podyplomowych z obszaru pedagogiki specjalnej, seksuologii,
                  seksuologii klinicznej. Terapeuta dzieci, par, rodzin.
                  Aktywnie angażuje się w pracę na rzecz dzieci w szkołach i
                  przedszkolach.{" "}
                </HoverCardContent>
              </HoverCard>
            </div>
