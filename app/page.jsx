...
const Home = () => {
  ...
  return (
    ...
    <p className=' text-center mb-6 mt-6'>Zapraszamy do skorzystania z ofert on-line lub stacjonarnie → <a className=' text-[#921d7f]' href="/assets/oferta-PPP-Magnolia.pdf" download={'Oferta'}>Oferta Poradni</a></p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 mt-10 md:mt-6 mb-10 md:mb-6 justify-center mx-4 md:mx-10">
        {/* Kafelek 3 */}
      ...
      {/* Dodano `position-relative` i `overflow-hidden` do kontenera, aby uniknąć wychodzenia zawartości poza granice */}
      <div className="w-full h-[550px] md:h-[600px] bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2 cursor-pointer relative overflow-hidden" style={{ backgroundImage: "url('/assets/kafelek3.jpg')", backgroundSize: 'cover' }}>
        
        {/* Usunięto nadmiarowe pozycjonowanie i uporządkowano strukturę */}
      ...
      <div className="w-full h-[550px] md:h-[600px] bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2 cursor-pointer relative overflow-hidden" style={{ backgroundImage: "url('/assets/kafelek1.jpg')", backgroundSize: 'cover' }}>
        ...
        <Link href='/Dorosli'>
      {/* Ustawiono 'overflow-hidden' i 'position-relative' dla kontenera zewnętrznego */}
      <div className="w-full h-[550px] md:h-[600px] bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-2 cursor-pointer relative overflow-hidden" style={{ backgroundImage: "url('/assets/kafelek2.jpg')", backgroundSize: 'cover' }}>
