    ...
    <main className='flex justify-center py-10'>
      <div className='flex flex-col items-center'>
        <img src="/assets/wynajem1.png" alt="Opis pierwszego obrazka" className="w-full max-w-5xl"/>
          <img src="/assets/wynajem2.png" alt="Opis pierwszego obrazka" className="w-full max-w-5xl mt-4"/>
        ...
        <div className='mt-6 text-left'> {/* Ustawienie tekstu od lewej strony */}
          ...
          <p className='text-slate-700  font-medium text-sm'>Magnolia CENTER w swojej ofercie prezentuje elegancką sale konferencyjną oraz nowoczesne gabinety lekarskie.</p><br />
          <p className='text-slate-700  font-bold text-sm'>Przestrzeń została zaprojektowana tak, aby ułatwić dyskusje, warsztaty i profesjonalne negocjacje w środowisku <br />dostosowanym do specyficznych klientów</p>
        ...
        <p className='text-slate-700 font-medium text-sm mt-6'>PROFESJONALNE GABINETY DLA TWOJEJ PRAKTYKI TERAPEUTYCZNEJ</p>
        <p className='text-slate-700 font-medium text-sm mt-6'>OFERUJEMY WYNAJEM GABINETÓW ORAZ SPECJALISTYCZNYCH SALTERAPEUTYCZNYCH DOSTOSOWANYCH DO TWOICH POTRZEB:</p>
        <p className='text-slate-700 font-bold text-sm mt-6'>1. Wynajem Gabinetów</p>
        <p className='text-slate-700 font-medium text-sm mt-6'>Dla lekarzy, terapeutów i specjalistów - komfortowe i wyposażone gabinety</p>
        <p className='text-slate-700 font-medium text-sm '>Dla prawników oraz innych specjalistów</p>
        <p className='text-slate-700 font-bold text-sm mt-6'>2. Sala do terapii sensorycznej</p>
        ...
        <p className='text-slate-700 font-medium text-sm mt-6'>Nowoczesna Sala do terapii VR, dostosowana i wyposażona w innowacyjny sprzęt do terapi vr.</p>
        <p className='text-slate-700 font-medium text-sm mt-6'>Nasza lokalizacja jest dogodna, a ceny konkurencyjne. Dbamy o czystość i bezpieczeństwo pomieszczeń. <br /> Skup się na pracy terapeutycznej - resztą zajmiemy się my. Skontaktuj się, by dowiedzieć się więcej!</p>
