  ...
  <div className="container mx-auto">
    <div className="grid grid-cols-1 gap-8 items-center flex-col md:flex-row md:grid-cols-2">
      ...
      <div className="image-container">
        <img src="/assets/psycholog1.jpg" alt="dziecko ubierające maskę" />
      </div>
      ...
      <h2 className="text-4xl md:text-5xl text-center md:text-left font-semibold mb-6 font-display text-slate-800">
        ...
        Wsparcie psychologiczne dla dorosłych ma na celu pomóc osobom w radzeniu sobie z trudnościami życiowymi, stresem, problemami emocjonalnymi czy zaburzeniami psychicznymi. Indywidualne sesje z doświadczonym psychologiem umożliwiają zidentyfikowanie i zrozumienie źródeł problemów, a następnie opracowanie skutecznych strategii radzenia sobie. Wsparcie psychologiczne może obejmować różnorodne techniki terapeutyczne, dostosowane do indywidualnych potrzeb klienta, umożliwiając osiągnięcie większej równowagi emocjonalnej i poprawę jakości życia.             
         ...
         <Link href={"/Kontakt"} className=' text-slate-800 flex justify-center md:block md:justify-start'><div className='mt-6 w-fit cursor-pointer flex items-center justify-center shadow-md border bg-slate-50/80 border-slate-700 rounded-xl custom-shadow'>Umów wizytę u Psychologa<FaRegArrowAltCircleRight /></div></Link>
...
<section className="py-6 md:py-24">
  <div className="container mx-auto">
    <div className="grid grid-cols-1 gap-8 items-center flex-col md:flex-row md:grid-cols-2">
      ...
      <div className="mx-5 flex-col justify-center items-center">
      <h2 className="text-4xl md:text-5xl text-center md:text-left font-semibold mb-6 font-display text-slate-800">
        Psychoterapia<br/>dla dorosłych
        </h2>
        ...
        <Link href={"/Kontakt"} className=' text-slate-800 flex justify-center md:block md:justify-start'><div className='mt-6 w-fit cursor-pointer flex items-center justify-center shadow-md border bg-slate-50/80 border-slate-700 rounded-xl custom-shadow'>Umów wizytę u Psychoterapeuty<FaRegArrowAltCircleRight /></div></Link>

      </div>
      <div className="text-center mb-4 md:mb-0 mx-5">
      <div className="image-container">
        <img src="/assets/psycholog2.jpg" alt="Psychoterapia" />
      </div>
...
<section className="py-6 md:py-24 mb-10">
  <div className="container mx-auto">
    <div className="grid grid-cols-1 gap-8 items-center flex-col md:flex-row md:grid-cols-2">
      ...
      <div className="text-center mb-4 md:mb-0 mx-5">
      <div className="image-container">
        <img src="/assets/psycholog3.jpg" alt="dziecko ubierające maskę" />
      </div>
      ...
      <h2 className="text-4xl md:text-5xl text-center md:text-left font-semibold mb-6 font-display text-slate-800">
        ...
        <Link href={"/Kontakt"} className=' text-slate-800 flex justify-center md:block md:justify-start'><div className='mt-6 w-fit cursor-pointer flex items-center justify-center shadow-md border bg-slate-50/80 border-slate-700 rounded-xl custom-shadow'>Umów wizytę dla par<FaRegArrowAltCircleRight /></div></Link>
