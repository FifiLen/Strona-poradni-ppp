...
fontWeight: "bold",
  ...
  return (
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white w-full md:w-[1600px] h-[80%] md:h-[600px] p-6 rounded-lg shadow-lg">
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", minHeight: "100vh", }}>
                <h1 className=' text-3xl md:text-5xl' style={{ fontFamily: "'Playfair Display', serif", }}>Kalendarz spotkań online</h1>
    ...
    <a href='/Webinary'
      ...
      className="bg-[#921d7f] hover:bg-[#b23b9e] text-white py-2 px-2 md:px-6 rounded-sm font-semibold transition duration-300 ease-in-out transform hover:scale-105 inline-block"
    >
      Kalendarz spotkań
    </a>
  </div>
