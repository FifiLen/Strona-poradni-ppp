...
return (
  ...
  <div className=' w-full h-10 bg-[#921d7f] flex justify-center items-center'>
    
    <button className=' text-white'>Przegapiłeś cykl webinarów o E-uzaleznieniach? <span className=' italic font-light'>(Zajrzyj tutaj→)</span> </button>
