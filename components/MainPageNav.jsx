...
export default function MainPageNav() {
 ...
 useEffect(() => {
  ...
  return (
    <header className={` header ${scrolled ? 'bg-white shadow-lg p-4' : ''}`}>
      <nav className="mx-auto flex w-full items-center justify-between p-3 lg:px-5" aria-label="Global">
        <div className={`flex  ${scrolled ? 'scale-75' : ''}`}>
          <Link href="/" className=" flex justify-start items-center">
            <Image src="/assets/LogoMainPage.svg" width={200} height={200} priority={true} alt="Logo poradni" />
        ...
        <Popover.Group className={`hidden md:flex-wrap md:mx-5 md:gap-x-6 lg:flex font-[450] lg:gap-x-10 bg-gray-200/70 rounded-md py-2 px-4 ${scrolled ? 'bg-white' : ''}`}>
        ...
        <div className="hidden lg:flex gap-2 lg:justify-end">
          ...
          <Link href="/Kontakt" className={`text-sm bg-gray-200/70 font-semibold py-2 px-5 rounded-md  leading-6 text-gray-900 ${scrolled ? 'bg-white' : ''}`}>
            Kontakt
          </Link>
