...
function ContactForm() {
  ...
  if (state.succeeded) {
    return <p className="text-lg font-semibold text-green-600">Dziękujemy za wiadomość!</p>;
  }
  return (
    <form 
      id="fs-frm" 
    ...
    >
      <fieldset id="fs-frm-inputs">
        <label htmlFor="full-name" className="block text-sm font-semibold text-gray-700 font-display">Imię/Pseudonim</label>
        <input type="text" name="name" id="full-name" placeholder="Imię/Pseudonim" required 
        ...
        <label htmlFor="email-address" className="block mt-3 text-sm font-semibold text-gray-700 font-display">Adres Email</label>
        ...
        <input type="hidden" name="_subject" id="email-subject" value="Zgłoszenie z formularza kontaktowego" />
      </fieldset>
