...
const Footer = () => {
  return (
    <footer className="py-16 flex justify-center bg-[#801c6f] border-t border-pink-300">
  ...
  <li className="mb-2 flex items-center">
    ...
    <span className="text-white font-semibold">123-456-789</span>
  </li>
              <li className="flex items-center space-x-4 mt-12 ">
